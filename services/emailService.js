...
module.exports.sendSystemEmail = async (email, data, type) => {
	...
	let mailOptions = {
		from: `Google Developer Student Club KIET <${SENDER_EMAIL}>`,
		replyTo: `Google Developer Student Club KIET <dsckiet@gmail.com>`,
		to: email,
		subject,
		html,
		headers: {
...
module.exports.sendGeneralEmail = async (email, subject, content) => {
	let mailOptions = {
		from: `DGoogle Developer Student Club KIET <${SENDER_EMAIL}>`,
		replyTo: `Google Developer Student Club KIET <dsckiet@gmail.com>`,
		to: email,
		subject,
		html: content,
